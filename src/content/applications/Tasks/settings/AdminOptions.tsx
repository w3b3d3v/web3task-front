          ...
          <Stack>
            <Box m={2}>
              ...
              <TextField
                label={"Role ID"}
                sx={{ mr: 2 }}
                onChange={(event) => handleInputChange("deposit", event)}
                name="roleId"
              />
              <TextField
                label={"Amount"}
              ...
              <Button
                variant="contained"
                onClick={(event) => handleSubmit("setDeposit", event)}
              >
                Enviar
              </Button>
            </Box>
            <Box m={2}>
              ...
              <Button
                variant="contained"
                onClick={(event) => handleSubmit("setRole", event)}
              >
                Enviar
              </Button>
            </Box>
            <Box m={2}>
              ...
              <Button
                variant="contained"
                onClick={(event) => handleSubmit("setOperator", event)}
              >
                Enviar
              </Button>
            </Box>
            <Box m={2}>
              ...
              <TextField
                label={"Value"}
                sx={{ mr: 2 }}
                onChange={(event) => handleInputChange("quorum", event)}
                name="Value"
              />
              <Button
                variant="contained"
                onClick={(event) => handleSubmit("setQuorum", event)}
              >
                Enviar
              </Button>
            </Box>
