...
interface TaskService {
    ...
    getMultiUserTasks: (address: any) => Promise<Task[]>;
}
...
export const useTaskServiceHook = (task: TaskService) => {
    ...
    const handleMultiUserTasks = async (address: any) => {
        const result: any = await task.getMultiUserTasks(address);
        let multiTask = [];
        try {
            setLoading(true);
            setError(null);
